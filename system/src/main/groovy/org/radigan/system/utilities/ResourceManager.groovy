...
// @author:  Mac Radigan
// @version: $Id: ResourceManager.groovy 76 2012-04-03 10:34:00Z mac.radigan $
...
public class ResourceManager {
  ...
  public File getRootDirectory() {
    ...
    if(systemHome) {
      ...
      if(!file.exists()) throw new Exception("""Environment variable SYSTEM_HOME = "${systemHome}" is not a valid directory.""")
      return file
    }
    //def protectionDomain = ResourceManager.class.getProtectionDomain()
    def protectionDomain = getClass().getProtectionDomain()
    ...
    // debug this later
    /*
    def parentFile = File(location.toURI()).getParentFile()
    def parent = parentFile.getName()
    if(parent=="target" || parent=="lib") {
