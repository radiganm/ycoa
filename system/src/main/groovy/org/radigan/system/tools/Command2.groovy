...
import org.radigan.system.tools.ITool
...
public class Command2 {
  ...
  public static void main(String[] args) {
    ...
    def loaders = ClassLoaders.getAppLoaders(ITool.class, getClass(), false)
    def providerClasses = []
    def buffer = resourceManager.getStream("/META-INF/services/org.radigan.system.tools.Tool")
    buffer.eachLine { line -> if(!line.startsWith("#")) providerClasses << line }
    def discoverClasses = new DiscoverClasses<ITool>(loaders)
    //def classList = []
    def providers = []
